 ...
 */
package com.example.utils.codec;

import com.example.utils.io.IOUtils;
...
public class Md5Utils {
	 ...
	 * 对流进行md5散列.
	 */
	public static String md5InputStream(InputStream input, int size) throws IOException {
		...
		if (size != -1 && available >= size){
			bytes = IOUtils.toByteArray(input, size);
		}else{
