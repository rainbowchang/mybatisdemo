 ...
 */
package com.example.utils.lang;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    private static final String[] workDay = {"星期一", "星期二", "星期三", "星期四", "星期五"};
    private static final String[] restDay = {"星期六", "星期日"};
...
//		System.out.println(formatDate(getOfDayLast(parseDate("2015/6/6")),"yyyy-MM-dd HH:mm:ss.sss"));
        ...
        Date date1 = DateUtils.parseDate("2019-09-05");
        Date date2 = new Date();
        double distance = DateUtils.getDistanceOfTwoDate(date1, date2);
        System.out.println("distance=" + distance);
        if (distance >= 0) {
            System.out.println("dnList=0");
        }else{
            System.out.println("dnList=1");
        }
