...
import com.example.utils.collect.ListUtils;
import com.example.utils.collect.MapUtils;
...
//        }));
	...
	public static void main(String[] args) {
		...
		Map<String, Object> map4 = JsonMapper.fromJson("{id:1,orderMaterialList:[{orderno:123,hasarrange:1},{orderno:234,hasarrange:3}],fee:{xxx:1,yyy:2}}", Map.class);
